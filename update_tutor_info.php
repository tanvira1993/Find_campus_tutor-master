...
<body class="bg-primary">
    ...
    <center>
        ...
        <form id="tutor" action="update_tutor_process.php" method="POST" >
            ...
            <table>
                ...
                <tr>
                 ...
                 <tr>
                    <td>Add Course Code for tution:</td>



                    <td>
                        <textarea rows="4" required="required" name="expert"> </textarea>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <textarea rows="4" required="required" name="addr"></textarea>
                    </td>
